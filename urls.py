...
urlpatterns = patterns('',
    ...
    url(r"^main/$", "django.views.generic.simple.direct_to_template", {"template": "base.html"}, name = 'main'),
    ...
    url(r'^create_match_cronic/$', 'hadimac.mac.views.create_match_cronic', name = 'create-match-cronic'),
