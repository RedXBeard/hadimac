...
urlpatterns = patterns('',
    ...
    url(r'^substitute/match/(?P<match_id>\d+)/$', 'hadimac.mac.views.substitute', name = 'substitute'),
    url(r'^substitute/(?P<key>\w+)/$', 'hadimac.mac.views.substitute1', name = 'substitute1'),
